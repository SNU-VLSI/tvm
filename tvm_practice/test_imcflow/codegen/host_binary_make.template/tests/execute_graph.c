...
// Forward declaration for scan register programming
// This function is generated by scan_codegen.py and linked during build
extern int32_t program_scan_reg(const char* file_name);
