...
def signals_post_imcu(tb, row, col):
    ...
    signals = [
        ...
        _sig("pimc_valid"),
        _sub("counters"),
        _fsig(f"{base}/i_cnt[1:0]", "UNSIGNED"),
        _sig("b_cnt[2:0]", "UNSIGNED"),
        _sig("i_step[2:0]", "UNSIGNED"),
        _sig("is_last_i_step"),
        _sig("is_last_output"),
        _sig("max_b_cnt[2:0]", "UNSIGNED"),
        _sig("shift_amt"),
        _sig("tot_shift_amt[3:0]", "UNSIGNED"),
        _endsub("counters"),
        _sub("acc_ctrl"),
        _fsig(f"{base}/acc_valid_i"),
        _sig("end_acc_i"),
        _sig("bypass_acc_i"),
        _sig("din_valid"),
        _sig("se_valid_o"),
        _endsub("acc_ctrl"),
        _sub("multmode"),
        _fsig(f"{base}/multmode_set_i"),
        _sig("vmode_i"),
        _sig("adcmode_i"),
        _endsub("multmode"),
        _sub("pimc_tx"),
        _fsig(f"{base}/pimc_tx/valid"),
        _sig("ready"),
        _endsub("pimc_tx"),
        _sub("u_serializer"),
...
def signals_imcu_ctrl(tb, row, col):
    ...
    signals = [
        ...
        _sub("acc_mode"),
        _fsig(f"{base}/is_acc_mode"),
        _sig("acc_cnt"),
        _sig("acc_hold"),
        _sig("acc_hold_wire"),
        _sig("acc_end_cnt[2:0]"),
        _sig("bypass_acc"),
        _sig("end_acc"),
        _sig("end_acc_buf"),
        _sig("valid_acc"),
        ...
        _sig("encoder_using"),
        _sig("encoder_buf"),
        _sig("bitshiftreg_valid"),
        _sig("bitpos[1:0]", "UNSIGNED"),
        _sig("acc_mask[3:0]"),
        _sig("ready_cnt[1:0]", "UNSIGNED"),
        _endsub("acc_mode"),
    ]
...
def signals_op_step(tb, row, col):
    ...
    signals = [
        ...
        _sub("post_imcu"),
        _fsig(f"{dp}/u_imcu_core/u_post_imcu/pimc_valid"),
        _sig("acc_valid_i"),
        _sig("end_acc_i"),
        _sig("bypass_acc_i"),
        _sig("din_valid"),
        ...
        _sig("multmode_set_i"),
        _sub("pimc_tx"),
        _fsig(f"{dp}/u_imcu_core/u_post_imcu/pimc_tx/valid"),
        _sig("ready"),
        _endsub("pimc_tx"),
        _endsub("post_imcu"),
    ]
