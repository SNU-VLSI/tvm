...
#
# Usage:
#   CKPT=n32_signed_sample ./scripts/build_csv_reconstructed_noise_table.sh [run_dir] [samples]
#
# Environment:
...
CSV="${CSV:-${BOARD}_noise_matrix_per_ch_concat.csv}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/root/project/CIM/noise/noise_df/${BOARD}_chip_inference/N32/${CKPT}}"
