...
void tvmgen_default_tvmgen_default_imcflow_main_46_round_imcflow_region1_main_0() {
  ...
  int* var7; // s39_d41func_out0_split0_recv_data_base_address
  int var8; // s39_d41func_out0_split0_tile_loop_count
  int var9; // recv_data_base_address
  int* var10; // s40_d41func_out1_split1_recv_data_base_address
  int var11; // s40_d41func_out1_split1_tile_loop_count
  if (hid == 0 && wid == 0) { // inode_0_0
    ...
    // generate: send - TensorEdge((-27, scale), (40, rhs)), inode_0_0 -> imce_0_1
    var4 = 64;
    // generate. loop count == 1
    __builtin_INODE_SEND(var4 + 0*32, 0, 4, 1);

    // endgenerate
    // endgenerate: send - TensorEdge((-27, scale), (40, rhs)), inode_0_0 -> imce_0_1
    ...
    for (int i1 = 0; i1 < 3; i1++) { // generate
      // generate: send - TensorEdge((-13, odata), (35, data)), inode_0_0 -> imce_0_2
      var5 = (int*)(13312);
      var4 = 0;
      var6 = var5[0];
      __asm__ volatile("nop");
      ...
      // endgenerate: send - TensorEdge((-13, odata), (35, data)), inode_0_0 -> imce_0_2
      // generate: sync all inodes
      __builtin_INODE_SET_FLAG(255);
      __builtin_INODE_STANDBY(5, 255);
      __builtin_INODE_STANDBY(10, 255);
    ...
    // endgenerate: halt for slave inodes
    for (int i1 = 0; i1 < 3; i1++) { // generate
      // generate: recv: TensorID(41, func_out1)
      var10 = (int*)(13312);
      var9 = 0;
      var11 = var10[0];
      __asm__ volatile("nop");
      ...
      // endgenerate: recv: TensorID(41, func_out1)
      // generate: sync all inodes
      __builtin_INODE_SET_FLAG(255);
      __builtin_INODE_STANDBY(0, 255);
      __builtin_INODE_STANDBY(5, 255);
    ...
    // endgenerate: halt for master inode after done and intrt
    for (int i1 = 0; i1 < 3; i1++) { // generate
      // generate: recv: TensorID(41, func_out0)
      var7 = (int*)(45056);
      var9 = 0;
      var8 = var7[0];
      __asm__ volatile("nop");
      ...
      // endgenerate: recv: TensorID(41, func_out0)
      // generate: sync all inodes
      __builtin_INODE_SET_FLAG(255);
      __builtin_INODE_STANDBY(0, 255);
      __builtin_INODE_STANDBY(5, 255);
