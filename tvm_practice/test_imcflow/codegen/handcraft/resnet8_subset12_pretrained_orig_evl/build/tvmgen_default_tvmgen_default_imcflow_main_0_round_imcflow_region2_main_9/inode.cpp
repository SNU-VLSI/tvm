...
void tvmgen_default_tvmgen_default_imcflow_main_0_round_imcflow_region2_main_9() {
  ...
  int* var5; // sm27_d33_30lhs_send_data_base_address
  int var6; // sm27_d33_30lhs_tile_loop_count
  int* var7; // sm28_d33_30rhs_send_data_base_address
  int var8; // sm28_d33_30rhs_tile_loop_count
  ...
  if (hid == 0 && wid == 0) { // inode_0_0
    ...
    __builtin_INODE_HALT();
    // endgenerate: halt for slave inodes
    // generate: send - TensorEdge((-27, odata), ((33, 30), lhs)), inode_0_0 -> imce_1_1
    var5 = (int*)(32768);
    var4 = 0;
    var6 = var5[0];
    __asm__ volatile("nop");
    for (int i1 = 0; i1 < var6; i1++) { // generate
      __builtin_INODE_STANDBY(6, 1);
      __builtin_INODE_SET_FLAG(1);
      __builtin_INODE_STANDBY(6, 0);
      __builtin_INODE_SET_FLAG(0);
      __builtin_INODE_SEND(var4 + i1*32, 0, 1, 2);

    } // endgenerate
    // endgenerate: send - TensorEdge((-27, odata), ((33, 30), lhs)), inode_0_0 -> imce_1_1
    // generate: sync all inodes
    __builtin_INODE_SET_FLAG(255);
    __builtin_INODE_STANDBY(5, 255);
    __builtin_INODE_STANDBY(10, 255);
    ...
    __builtin_INODE_SET_FLAG(0);
    // endgenerate: wait all imce compute enable
    // generate: send - TensorEdge(((33, -31), min), ((33, 31), min)), inode_1_0 -> imce_1_1
    var4 = 0;
    // generate. loop count == 1
    __builtin_INODE_SEND(var4 + 0*32, 0, 1, 1);

    // endgenerate
    // endgenerate: send - TensorEdge(((33, -31), min), ((33, 31), min)), inode_1_0 -> imce_1_1
    // generate: send - TensorEdge(((33, -32), max), ((33, 31), max)), inode_1_0 -> imce_1_1
    var4 = 32;
    // generate. loop count == 1
    __builtin_INODE_SEND(var4 + 0*32, 0, 2, 1);

    // endgenerate
    // endgenerate: send - TensorEdge(((33, -32), max), ((33, 31), max)), inode_1_0 -> imce_1_1
    // generate: sync all inodes
    __builtin_INODE_SET_FLAG(255);
    __builtin_INODE_STANDBY(0, 255);
    __builtin_INODE_STANDBY(10, 255);
    ...
    __builtin_INODE_HALT();
    // endgenerate: halt for slave inodes
    // generate: send - TensorEdge((-28, odata), ((33, 30), rhs)), inode_1_0 -> imce_1_1
    var7 = (int*)(32768);
    var4 = 0;
    var8 = var7[0];
    __asm__ volatile("nop");
    ...
    // endgenerate: send - TensorEdge((-28, odata), ((33, 30), rhs)), inode_1_0 -> imce_1_1
    // generate: sync all inodes
    __builtin_INODE_SET_FLAG(255);
    __builtin_INODE_STANDBY(0, 255);
    __builtin_INODE_STANDBY(10, 255);
    ...
    __builtin_INODE_SET_FLAG(0);
    // endgenerate: wait all imce compute enable
    // generate: send - TensorEdge((-34, config), (34, config)), inode_2_0 -> imce_2_1
    var4 = 8192;
    // generate. loop count == 1
    __builtin_INODE_SEND(var4 + 0*32, 0, 3, 1);

    // endgenerate
    // endgenerate: send - TensorEdge((-34, config), (34, config)), inode_2_0 -> imce_2_1
    // generate: sync all inodes
    __builtin_INODE_SET_FLAG(255);
    __builtin_INODE_STANDBY(0, 255);
    __builtin_INODE_STANDBY(5, 255);
