...
void tvmgen_default_tvmgen_default_imcflow_main_46_round_imcflow_region3_main_39() {
  ...
  if (hid == 0 && wid == 1) { // imce_0_1
    ...
    for (int i1 = 0; i1 < 256; i1++) { // generate : call_created_loop
      ...
      __builtin_IMCE_STANDBY(5, 1);
      __builtin_IMCE_SETFLAG(0);
      short16 var350, var351, var352;
      var350 = __builtin_IMCE_RECV(2);
      var351 = __builtin_IMCE_RECV(3);
      // generate: imcflow.vecops_block
      // generate: add

      var52 = __builtin_IMCE_ADD(var50, var51, 15);
      var352 = __builtin_IMCE_ADD(var350, var351, 15);
      // endgenerate: add
      ...
      __builtin_IMCE_STANDBY(8, 0);
      __builtin_IMCE_SETFLAG(0);
      __builtin_IMCE_SEND(1, var52, 2, 0); // TensorEdge(((88, 86), odata), (104, data)),TensorEdge(((88, 86), odata), (89, data)), imce_0_3 -> imce_0_2
      __builtin_IMCE_SEND(1, var352, 2, 0); // TensorEdge(((88, 86), odata), (104, data)),TensorEdge(((88, 86), odata), (89, data)), imce_0_3 -> imce_0_2
