...
void tvmgen_default_tvmgen_default_imcflow_main_46_round_imcflow_region1_main_0() {
  ...
  short16 var9; // (TensorEdge((-27, scale), (40, rhs)), 0)
  short16 var10; // (TensorEdge((-13, odata), (40, lhs)), 0)
  short16 var11; // (MultlBlock(gid: 40), 0)
  short16 var12; // ((MultlBlock(gid: 40), 0), 'L')
  short16 var13; // ((MultlBlock(gid: 40), 0), 'H')
  short16 var14; // ((MultlBlock(gid: 40), 0), 'neg1')
  short16 var15; // ((MultlBlock(gid: 40), 0), 'const_7fff')
  short16 var16; // ((MultlBlock(gid: 40), 0), 'H_sign')
  short16 var17; // ((MultlBlock(gid: 40), 0), 'L_sign')
  short16 var18; // ((MultlBlock(gid: 40), 0), 'mismatch')
  short16 var19; // ((MultlBlock(gid: 40), 0), 'saturate_val')
  short16 var20; // ((MultlBlock(gid: 40), 0), 'not_mismatch')
  short16 var21; // ((MultlBlock(gid: 40), 0), 'part1')
  short16 var22; // ((MultlBlock(gid: 40), 0), 'part2')
  short16 var23; // (TensorEdge((-19, min), (35, min)), 0)
  short16 var24; // (TensorEdge((-20, max), (35, max)), 0)
  short16 var25; // (TensorEdge((-13, odata), (35, data)), 0)
  short16 var26; // (MinmaxQuantBlock(gid: 35), 0)
  short16 var27; // (MinmaxQuantBlock(gid: 35), 1)
  short16 var28; // (MinmaxQuantBlock(gid: 35), 2)
  short16 var29; // (MinmaxQuantBlock(gid: 35), 3)
  short16 var30; // (TensorEdge(((37, -15), fused_scale), ((37, 32), fused_scale)), 0)
  short16 var31; // (TensorEdge(((37, -16), fused_bias), ((37, 32), fused_bias)), 0)
  short16 var32; // (TensorEdge(((37, -17), min), ((37, 33), min)), 0)
  short16 var33; // (TensorEdge(((37, -18), max), ((37, 33), max)), 0)
  short16 var34; // (TensorEdge((36, odata), ((37, 32), data)), 0)
  short16 var35; // (TensorEdge((36, odata), ((37, 32), data)), 1)
  short16 var36; // (TensorEdge((36, odata), ((37, 32), data)), 2)
  short16 var37; // (TensorEdge((36, odata), ((37, 32), data)), 3)
  short16 var38; // (MinmaxQuantBlock(gid: 33), 0)
  short16 var39; // (MinmaxQuantBlock(gid: 33), 1)
  short16 var40; // (MinmaxQuantBlock(gid: 33), 2)
  short16 var41; // (MinmaxQuantBlock(gid: 33), 3)
  short16 var42; // (BatchNormBlock(gid: 32), 0)
  short16 var43; // (BatchNormBlock(gid: 32), 0, 'mult_result')
  short16 var44; // ((BatchNormBlock(gid: 32), 0), 'L')
  short16 var45; // ((BatchNormBlock(gid: 32), 0), 'H')
  short16 var46; // ((BatchNormBlock(gid: 32), 0), 'neg1')
  short16 var47; // ((BatchNormBlock(gid: 32), 0), 'const_7fff')
  short16 var48; // ((BatchNormBlock(gid: 32), 0), 'H_sign')
  short16 var49; // ((BatchNormBlock(gid: 32), 0), 'L_sign')
  short16 var50; // ((BatchNormBlock(gid: 32), 0), 'mismatch')
  short16 var51; // ((BatchNormBlock(gid: 32), 0), 'saturate_val')
  short16 var52; // ((BatchNormBlock(gid: 32), 0), 'not_mismatch')
  short16 var53; // ((BatchNormBlock(gid: 32), 0), 'part1')
  short16 var54; // ((BatchNormBlock(gid: 32), 0), 'part2')
  short16 var55; // (TensorEdge((-22, config), (36, config)), 0)
  short16 var56; // (TensorEdge((35, odata), (36, data)), 0)
  short16 var57; // (TensorEdge((35, odata), (36, data)), 1)
  short16 var58; // (TensorEdge((35, odata), (36, data)), 2)
  short16 var59; // (TensorEdge((35, odata), (36, data)), 3)
  short16 var60; // (TensorEdge((-24, config), (38, config)), 0)
  short16 var61; // (TensorEdge(((37, 33), odata), (38, data)), 0)
  short16 var62; // (TensorEdge(((37, 33), odata), (38, data)), 1)
  short16 var63; // (TensorEdge(((37, 33), odata), (38, data)), 2)
  short16 var64; // (TensorEdge(((37, 33), odata), (38, data)), 3)
  short16 var65; // (TensorEdge((-25, fused_scale), (39, fused_scale)), 0)
  short16 var66; // (TensorEdge((-26, fused_bias), (39, fused_bias)), 0)
  short16 var67; // (TensorEdge((38, odata), (39, data)), 0)
  short16 var68; // (BatchNormBlock(gid: 39), 0)
  short16 var69; // (BatchNormBlock(gid: 39), 0, 'mult_result')
  short16 var70; // ((BatchNormBlock(gid: 39), 0), 'L')
  short16 var71; // ((BatchNormBlock(gid: 39), 0), 'H')
  short16 var72; // ((BatchNormBlock(gid: 39), 0), 'neg1')
  short16 var73; // ((BatchNormBlock(gid: 39), 0), 'const_7fff')
  short16 var74; // ((BatchNormBlock(gid: 39), 0), 'H_sign')
  short16 var75; // ((BatchNormBlock(gid: 39), 0), 'L_sign')
  short16 var76; // ((BatchNormBlock(gid: 39), 0), 'mismatch')
  short16 var77; // ((BatchNormBlock(gid: 39), 0), 'saturate_val')
  short16 var78; // ((BatchNormBlock(gid: 39), 0), 'not_mismatch')
  short16 var79; // ((BatchNormBlock(gid: 39), 0), 'part1')
  short16 var80; // ((BatchNormBlock(gid: 39), 0), 'part2')
  if (hid == 0 && wid == 1) { // imce_0_1
    ...
    for (int i1 = 0; i1 < 1024; i1++) { // generate : call_created_loop
      ...
      var10 = __builtin_IMCE_RECV(2); // TensorEdge((-13, odata), (40, lhs)), inode_0_0 -> imce_0_1
      // generate: multl
      ...
      // endgenerate: multl
      __builtin_IMCE_SEND(1, var11, 2, 0); // TensorEdge((40, odata), (41, func_out1), 1), imce_0_1 -> inode_2_0
    ...
    for (int i1 = 0; i1 < 1024; i1++) { // generate : call_created_loop
      ...
      __builtin_IMCE_SEND(1, var26, 0, 0); // TensorEdge((35, odata), (36, data)), imce_0_2 -> imce_1_2
