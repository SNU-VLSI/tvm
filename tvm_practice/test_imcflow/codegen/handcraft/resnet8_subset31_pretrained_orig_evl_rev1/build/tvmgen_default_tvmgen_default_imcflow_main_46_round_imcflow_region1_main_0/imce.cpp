...
void tvmgen_default_tvmgen_default_imcflow_main_46_round_imcflow_region1_main_0() {
  ...
  if (hid == 0 && wid == 1) { // imce_0_1
    ...
    for (int i1 = 0; i1 < 32; i1++) { // generate : conv exec0_row_group2_col_group0
      ...
      // loop ignored with loop count == 0 : load_block
      // endgenerate: load_block
      __builtin_IMCE_SEND(1, 0, 2, 0); // TensorEdge((39, odata), ((40, 35), data)), imce_1_2 -> imce_1_1
      __builtin_IMCE_SEND(1, 0, 2, 0); // TensorEdge((39, odata), ((40, 35), data)), imce_1_2 -> imce_1_1
      __builtin_IMCE_SEND(1, 0, 2, 0); // TensorEdge((39, odata), ((40, 35), data)), imce_1_2 -> imce_1_1
      __builtin_IMCE_SEND(1, 0, 2, 0); // TensorEdge((39, odata), ((40, 35), data)), imce_1_2 -> imce_1_1
    ...
    for (int i1 = 0; i1 < 1024; i1++) { // generate : call_created_loop
      ...
      short16 var271, var371, var471;
      __builtin_IMCE_SETFLAG(1);
      var71 = __builtin_IMCE_RECV(2); // TensorEdge((41, odata), (42, data)), imce_2_1 -> imce_3_1
      var271 = __builtin_IMCE_RECV(2); // TensorEdge((41, odata), (42, data)), imce_2_1 -> imce_3_1
      var371 = __builtin_IMCE_RECV(2); // TensorEdge((41, odata), (42, data)), imce_2_1 -> imce_3_1
      var471 = __builtin_IMCE_RECV(2); // TensorEdge((41, odata), (42, data)), imce_2_1 -> imce_3_1
      __builtin_IMCE_SETFLAG(0);
      // generate: batch_norm
      ...
      __builtin_IMCE_SEND(1, 0, 2, 0); // TensorEdge((42, odata), (47, func_out0), 0), imce_3_1 -> inode_3_0
      __builtin_IMCE_SEND(1, 0, 2, 0); // TensorEdge((42, odata), (47, func_out0), 0), imce_3_1 -> inode_3_0
      __builtin_IMCE_SEND(1, 0, 2, 0); // TensorEdge((42, odata), (47, func_out0), 0), imce_3_1 -> inode_3_0
