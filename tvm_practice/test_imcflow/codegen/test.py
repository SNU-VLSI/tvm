...
MODEL_REGISTRY = {
    ...
    "s2_conv_quant_conv_big": (lambda: models_for_test.getS2ConvQuantModel(iH=32, iW=32), "random"),
    ...
    "s2_conv_quant_conv": (lambda: models_for_test.getS2ConvQuantModel(iH=1,iW=1), "random"),
    ...
    "resnet8_subset09_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=9), "ones"),
    "resnet8_subset10_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=10), "ones"),
    "resnet8_subset11_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=11), "ones"),
    "resnet8_subset12_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=12), "ones"),
    "resnet8_subset13_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=13), "ones"),
    "resnet8_subset14_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=14), "ones"),
    "resnet8_subset15_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=15), "ones"),
    "resnet8_subset16_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=16), "ones"),
    "resnet8_subset17_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=17), "ones"),
    "resnet8_subset18_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=18), "ones"),
    "resnet8_subset19_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=19), "ones"),
    "resnet8_subset20_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=20), "ones"),
    "resnet8_subset21_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=21), "ones"),
    "resnet8_subset22_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=22), "ones"),
    "resnet8_subset23_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=23), "ones"),
    "resnet8_subset24_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=24), "ones"),
    "resnet8_subset25_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=25), "ones"),
    "resnet8_subset31_pretrained": (lambda: resnet8_subset_models.getModel_from_pretrained_weight(small_debug=False, until_relay=31), "ones"),
