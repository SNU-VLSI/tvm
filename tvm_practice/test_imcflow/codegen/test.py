...
MODEL_REGISTRY = {
    ...
    "one_dwconv_v2": (lambda: models_for_test.getOneDWConvModel(iH=4,iW=4, IC=32), "random"),
    "one_dwconv_v3": (lambda: models_for_test.getOneDWConvModel(iH=4,iW=4, IC=64), "random"),
