...
# alias run="python test.py -k "test_resnet8"               -s 2>&1 | tee resnet.log"
# alias dbg="python_dbg test.py -k "test_resnet8"               -s 2>&1 | tee resnet.log"

# python test.py -k "test_resnet8"               -s 2>&1 | tee resnet.log
