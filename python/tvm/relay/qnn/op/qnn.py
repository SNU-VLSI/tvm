...
def imcflow_min_max_quantize(data, min, max, axis=-1, out_dtype="float32", param_dtype="float32"):
    return _make.imcflow_min_max_quantize(data, min, max, axis, out_dtype, param_dtype)
