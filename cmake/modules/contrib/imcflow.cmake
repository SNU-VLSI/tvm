...
if(USE_IMCFLOW)
  ...
  if(USE_IMCFLOW STREQUAL "VIRTUAL")
    add_definitions(-DUSE_IMCFLOW_VIRTUAL=1)
    message(STATUS "Build with IMCLFOW virtual module")
  else()
    add_definitions(-DUSE_IMCFLOW_CSRC=1)
